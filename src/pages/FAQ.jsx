    ...
    items: [
      {
        ...
        a: "Ambas modalidades están disponibles. Las sesiones presenciales se realizan en Olivos, a metros de la Estación (línea Mitre). Las sesiones online funcionan igual de bien para quienes viven en otra ciudad o en el exterior.",
      },
      {
